...
function useCollage() {
  return useMemo(() => {
    const pal = ['#1B5A50', '#0F4A42', '#2A6C60', '#164F46', '#22635A'];
    const out = [];
        ...
        <div className="f-top">
          ...
          <div className="rv">
            ...
            <ul className="f-contact">
              <li>
                <span className="ico">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#123A32" strokeWidth="2">
          ...
          <div className="rv">
            ...
            <div className="social">
              <a href="#" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#D9E9E5"><path d="M14 9h3V6h-3c-2.2 0-4 1.8-4 4v2H8v3h2v7h3v-7h3l1-3h-4v-2c0-.6.4-1 1-1Z" /></svg>
              </a>
              <a href="#" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#D9E9E5"><path d="M12 2c2.7 0 3 0 4.1.1 1.1 0 1.8.2 2.4.5.7.2 1.2.6 1.7 1.1s.9 1 1.1 1.7c.3.6.5 1.3.5 2.4C22 9 22 9.3 22 12s0 3-.1 4.1c0 1.1-.2 1.8-.5 2.4a4.6 4.6 0 0 1-1.1 1.7 4.6 4.6 0 0 1-1.7 1.1c-.6.3-1.3.5-2.4.5-1.1.1-1.4.1-4.1.1s-3 0-4.1-.1c-1.1 0-1.8-.2-2.4-.5a4.6 4.6 0 0 1-1.7-1.1 4.6 4.6 0 0 1-1.1-1.7c-.3-.6-.5-1.3-.5-2.4C2 15 2 14.7 2 12s0-3 .1-4.1c0-1.1.2-1.8.5-2.4.2-.7.6-1.2 1.1-1.7s1-.9 1.7-1.1c.6-.3 1.3-.5 2.4-.5C9 2 9.3 2 12 2Zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 2.2a2.8 2.8 0 1 1 0 5.6 2.8 2.8 0 0 1 0-5.6ZM17.5 5.3a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Z" /></svg>
              </a>
              <a href="#" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#D9E9E5"><path d="M6.9 8.5v11.6H3.2V8.5h3.7ZM5.1 2.9a2.1 2.1 0 1 1 0 4.3 2.1 2.1 0 0 1 0-4.3ZM20.8 20.1h-3.7v-6.1c0-1.5-.5-2.5-1.8-2.5-1 0-1.6.7-1.9 1.4-.1.2-.1.6-.1.9v6.3H9.6V8.5h3.7v1.6a3.7 3.7 0 0 1 3.3-1.9c2.4 0 4.2 1.6 4.2 5v6.9Z" /></svg>
              </a>
            </div>
