...
const Check = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M3 13l6 6L21 5" stroke="#D9A93A" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
    ...
    <section className="showcase" id="works">
      <div className="sc-top on-dark">
        <svg className="swoosh" viewBox="0 0 1400 800" preserveAspectRatio="none" aria-hidden="true">
          <g fill="none" stroke="#5FA396" strokeWidth="1.2">
        ...
        <div className="wrap center rv">
          <svg className="arrow" viewBox="0 0 240 80" fill="none" aria-hidden="true">
            <path d="M8 62C22 30 52 16 66 34s-14 34-24 20 6-38 40-40 60 14 78 6" stroke="#D9A93A" strokeWidth="6" strokeLinecap="round" />
            <path d="M148 8l24 12-20 18" stroke="#D9A93A" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M232 26a30 30 0 1 1-42-6" stroke="#6FCFB8" strokeWidth="6" strokeLinecap="round" />
          </svg>
          ...
          <p className="lede" style={{ marginTop: 16, color: '#CDE3DE' }}>
      ...
      <div className="sc-bottom" id="services">
        <svg className="deco deco-l" viewBox="0 0 400 400" aria-hidden="true">
          <circle cx="180" cy="230" r="170" fill="#4A2C63" />
          <g transform="rotate(-14 200 220)">
            <rect x="60" y="200" width="150" height="200" rx="4" fill="#F4F1EA" />
            <rect x="72" y="222" width="120" height="7" rx="3" fill="#D9A93A" />
            <rect x="72" y="242" width="90" height="7" rx="3" fill="#C46A4E" />
          </g>
          <g transform="rotate(12 240 180)">
            <rect x="170" y="120" width="150" height="205" rx="4" fill="#F3C64A" />
            <rect x="184" y="146" width="118" height="9" rx="4" fill="#1D5AA8" />
            <rect x="184" y="270" width="90" height="7" rx="3" fill="#1D5AA8" />
          </g>
        </svg>
        <svg className="deco deco-r" viewBox="0 0 400 400" aria-hidden="true">
          <g transform="rotate(-8 160 240)">
            <rect x="40" y="150" width="160" height="250" rx="4" fill="#F2C94C" />
            <circle cx="120" cy="240" r="40" fill="#E8873B" />
            <rect x="60" y="330" width="120" height="8" rx="4" fill="#1B4A8A" />
          </g>
          <g transform="rotate(9 260 230)">
            <rect x="180" y="120" width="170" height="270" rx="4" fill="#8A3B22" />
            <rect x="196" y="150" width="138" height="9" rx="4" fill="#F0D9A8" />
            <circle cx="265" cy="250" r="46" fill="#C9603A" />
            <rect x="212" y="340" width="106" height="8" rx="4" fill="#F0D9A8" />
          </g>
        </svg>
